...
promptforqna=['Find all the medical history and diagnosis of the patient. Do not include text within box brackets',
                ...
                'Find all the medications that the patient has been prescribed for a fixed span of time like only few days. Do not include text within box brackets',
              'Find all the medications that the patient has been prescribed for long period like daily use. Do not include text within box brackets',
...
promptforgpt=['Get all the current and past medical diagnosis from the below extracts, label the reponse as Past Medical History.Do not include text within box brackets',
                ...
                'Get all the medications that the patient has been prescribed for a fixed span of time like only few days from the below extracts, label it as Past Medications. Do not include text within box brackets',
              'Get all the medications that the patient has been prescribed for long period like daily use from the below extracts, label it as Current Medications. Do not include text within box brackets',
